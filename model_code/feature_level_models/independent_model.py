...
def main():
    ...
    save_folder = r"../model_results/FP/Choi2017_broken_"
    # save_folder = r"/home/kohler.d/MSbayesImp/model_results/Choi2017_"
    # input_data = pd.read_csv(r"/home/kohler.d/MSbayesImp/data/Choi2017_model_input_normalized.csv")
    ...
    sample_proteins = input_data["Protein"].unique()[:200]
    ...
    model.train(input_data, 500, 500,
